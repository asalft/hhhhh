...
BaqirDV_cmd = (
    "[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 aSaL - اوامــر المطـور المســاعد](t.me/a_vun) .\n\n"
...
async def add_sudo_user(event):
    ...
    output += "**「❖╎يتم الان اعـادة تشغيـل بـوت aSaL انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن aSaL :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**「❖╎يتم الان اعـادة تشغيـل بـوت aSaL انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
