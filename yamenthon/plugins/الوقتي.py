...
autopic_path = os.path.join(os.getcwd(), "a_vun", "original_pic.png")
digitalpic_path = os.path.join(os.getcwd(), "a_vun", "digital_pic.png")
autophoto_path = os.path.join(os.getcwd(), "a_vun", "photo_pfp.png")
    ...
    while DIGITALPICSTART:
        if not os.path.exists(digitalpic_path):
            ...
            while not downloader.isFinished():
                pass
        zedfont = gvarstatus("DEFAULT_PIC") or "a_vun/helpers/styles/Papernotes.ttf"
    ...
    while AUTOBIOSTART:
        ...
        for normal in HM:
            if normal in normzltext:
              ...
              namefont = namerzfont[normzltext.index(normal)]
              HM = HM.replace(normal, namefont)
        DEFAULTUSERBIO = gvarstatus("DEFAULT_BIO") or "الحمد الله على كل شئ - @a_vun"
